...
```{r}
# Plots Box plot of Temp by Month
library("ggpubr")
ggboxplot(TempMonth, x = "Month", y = "Temp", 
          color = "Month", palette = c("blue", "red"),
          ylab = "Temp", xlab = "Month")

```

The box plot further confirms the results of the t-test as it is very clear that the two groups have different means.
